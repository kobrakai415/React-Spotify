        ...
        return (
            <>
                ...
                <Router>
                    ...
                    <Route path="/" exact>
                        <Mainpage selectedSongHandler={this.selectedSongHandler} songs={this.state.songs} />
                    </Route>
                    ...
                    <Route exact path="/album/:id" render={(routerProps) => <Albumpage  {...routerProps} /> }/>
                </Router>
                    <Mediaplayer selectedSong={this.state.selectedSong} />
                {/* </div>
                </div> */}
